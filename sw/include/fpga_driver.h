...
// Shamir IP offset
#define SHAMIR_BASE_OFFSET SHAMIRE_CORE_0_BASE

// Register offsets (by 4 for byte offset)
...
#define REG_COEFF0 5    /* 0x14 - Coeff 0 (a0 for gen, a1 for brute) */
...
#define REG_SHARE_X4 19 /* 0x4C - Share 4 X */
#define REG_SHARE_Y4 20 /* 0x50 - Share 4 Y */
#define REG_SHARE_X5 21 /* 0x54 - Share 5 X */
#define REG_SHARE_Y5 22 /* 0x58 - Share 5 Y */
#define REG_SHARE_X6 23 /* 0x5C - Share 6 X */
#define REG_SHARE_Y6 24 /* 0x60 - Share 6 Y */
#define REG_SHARE_X7 25 /* 0x64 - Share 7 X */
#define REG_SHARE_Y7 26 /* 0x68 - Share 7 Y */
#define REG_COEFF4 27   /* 0x6C - Coefficient 4 (a4) */
#define REG_COEFF5 28   /* 0x70 - Coefficient 5 (a5) */
#define REG_COEFF6 29   /* 0x74 - Coefficient 6 (a6) */
#define REG_COEFF7 30   /* 0x78 - Coefficient 7 (a7) */
